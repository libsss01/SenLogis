 <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="index.php" class="logo d-flex align-items-center me-auto">
        ...
        <!-- <img src="public/template/templateVitrine/Logis/assets/img/logo.png" alt=""> -->
        <h1 class="sitename">SenLogis</h1>
      </a>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="public/template/templateVitrine/Logis/starter-page.html"><span>Solutions</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li class="dropdown"><a href="public/template/templateVitrine/Logis/service-details.html"><span>Détails</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                <ul>
